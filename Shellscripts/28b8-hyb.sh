#!/bin/bash
#SBATCH --job-name=28b8hyb      # Job name
...
#SBATCH --output=28b8-hyb%j.log     # Standard output and error log
pwd; hostname; date

echo "Running 28b8 large dataset on $SLURM_CPUS_ON_NODE CPU cores"
mpirun -n 2 -bootstrap slurm /home/smdupor/ParallelRadix/bin/main_hyb -f /mnt/beegfs/smdupor/dataset28b8.txt -n 4 -r 1659025
