#!/bin/bash
#SBATCH --job-name=16b8omp     # Job name
...
mpirun -n 1 -bootstrap slurm /home/smdupor/ParallelRadix/bin/main_omp8x4 -f /mnt/beegfs/smdupor/dataset16b8.txt -n 4 -r 1659025
