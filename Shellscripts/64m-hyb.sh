#!/bin/bash
#SBATCH --job-name=64mhyb      # Job name
...
#SBATCH --output=64m-hyb%j.log     # Standard output and error log
pwd; hostname; date

echo "Running 64m large dataset on $SLURM_CPUS_ON_NODE CPU cores"
mpirun -n 2 -bootstrap slurm /home/smdupor/ParallelRadix/bin/main_hyb -f /mnt/beegfs/smdupor/64m.txt -n 4 -r 1659025
