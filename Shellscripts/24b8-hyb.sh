#!/bin/bash
#SBATCH --job-name=24b8hyb      # Job name
...
#SBATCH --output=24b8-hyb%j.log     # Standard output and error log
pwd; hostname; date

echo "Running 24b8 large dataset on $SLURM_CPUS_ON_NODE CPU cores"
mpirun -n 2 -bootstrap slurm /home/smdupor/ParallelRadix/bin/main_hyb -f /mnt/beegfs/smdupor/dataset24b8.txt -n 4 -r 1659025
