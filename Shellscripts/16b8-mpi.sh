#!/bin/bash
#SBATCH --job-name=16b8mpi      # Job name
...
#SBATCH --output=16b8-mpi%j.log     # Standard output and error log
pwd; hostname; date

echo "Running 16b8 large dataset on $SLURM_CPUS_ON_NODE CPU cores"
mpirun -n 4 -bootstrap slurm /home/smdupor/ParallelRadix/bin/main_mpi -f /mnt/beegfs/smdupor/dataset16b8.txt -n 4 -r 1659025
