#!/bin/bash
#SBATCH --job-name=84mhyb      # Job name
...
#SBATCH --output=84m-hyb%j.log     # Standard output and error log
pwd; hostname; date

echo "Running 84m large dataset on $SLURM_CPUS_ON_NODE CPU cores"
mpirun -n 2 -bootstrap slurm /home/smdupor/ParallelRadix/bin/main_hyb -f /mnt/beegfs/smdupor/84m.txt -n 4 -r 1659025
