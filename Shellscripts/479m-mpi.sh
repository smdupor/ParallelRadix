#!/bin/bash
#SBATCH --job-name=479mmpi      # Job name
...
#SBATCH --output=479m-mpi%j.log     # Standard output and error log
pwd; hostname; date

echo "Running 479m large dataset on $SLURM_CPUS_ON_NODE CPU cores"
mpirun -n 4 -bootstrap slurm /home/smdupor/ParallelRadix/bin/main_mpi -f /mnt/beegfs/smdupor/479m.txt -n 4 -r 1659025
